...
variable "admin_ip_cidr" {
  description = "A trusted IP address range (CIDR format) for SSH access."
  type        = string
  # NOTE: In a real project, you would replace this with your office or VPN IP.
  default     = "73.73.73.73/32"
}